...
| Production deploy | Live | v2.2.2 deployed to kb.ss-42.com — latest: session 81 |
...
| 81 | v2.2.2 | Auth resilience — shared auth pool 5→10, timeout 5s→10s, frontend retry on transient 401 (#207). Quick fix before DB consolidation (#208). |

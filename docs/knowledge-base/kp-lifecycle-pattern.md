...
> The master copy of this document now lives in the Knowledge Base vault.
> Read and write the vault copy instead: `knowledge-base/vault/work/engineering-practice/lifecycle-pattern.md`
> This file will be removed once the project confirms migration.
